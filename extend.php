...
<body class="bg-default">
    ...
    <div class="container">
      ...
      <div class="navbar-collapse navbar-custom-collapse collapse" id="navbar-collapse">
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a href="register.php" class="nav-link">
              <span class="nav-link-inner--text">Extend Subscription</span>
            </a>
          </li>
        </ul>
        <hr class="d-lg-none" />
        <ul class="navbar-nav align-items-lg-center ml-lg-auto">
          ...
          <li class="nav-item">
            <a class="nav-link nav-link-icon" href="#" data-toggle="tooltip" data-original-title="Join our discord server">
              <i class="fab fa-discord"></i>
              <span class="nav-link-inner--text d-lg-none">Discord</span>
            </a>
          </li>
          <li class="nav-item d-none d-lg-block ml-lg-4">
            <a data-sellix-product="11111111" class="btn btn-neutral btn-icon">
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              ...
              <p class="text-lead text-white"><!-- Add a description here --></p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="card bg-secondary border-0 mb-0">
            <div class="card-body px-lg-5 py-lg-5">
              <div class="text-center text-muted mb-4">
                <h3 class="mb-4 text-center">Extend Subscription</h3>
                <span class="mb-0 text-muted">Fill out the form below to extend your subscription.</span>
              </div>
              <form role="form" method="POST">
                ...
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control" placeholder="License" type="text" name="license">
                  </div>
                </div>
                <div class="text-center">
                  <button type="submit" class="btn btn-primary mt-4" name="register">Submit</button>
                </div>
              </form>
            </div>
          </div>
      ...
      <div class="row align-items-center justify-content-xl-between">
        <div class="col-xl-6">
          <div class="copyright text-center text-xl-left text-muted">
            Copyright &copy; 2021 <a href="https://authguard.net" class="font-weight-bold" target="_blank">AuthGuard</a>
          </div>
        </div>
        <div class="col-xl-6">
  ...
  <?php
    ...
    if (isset($_POST["register"]))
    {
      ...
      if (AuthGuard::UseLicense($username, $license))
      {
        AuthGuard::success("You have successfully extended your subscription!");
      }
    }
  ?>
