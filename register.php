...
<body class="bg-default">
        ...
        <div class="col-lg-6 col-md-8">
          <div class="card bg-secondary border-0 mb-0">
            <div class="card-body px-lg-5 py-lg-5">
              <div class="text-center text-muted mb-4">
                ...
                <span class="mb-0 text-muted text-center">Fill out the form carefully for registration.</span>
              </div>
          ...
          <div class="row mt-3">
            ...
            <div class="col-6 text-right">
              <a href="extend.php" class="text-light"><small>Extend Subscription</small></a>
            </div>
          </div>
        </div>
      </div>
  ...
  <?php
    ...
    if (isset($_POST["register"]))
    {
      ...
      if (AuthGuard::Register($username, $password, $email, $license))
      {
