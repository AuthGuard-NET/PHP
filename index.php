...
<body class="bg-default">
    ...
    <div class="container">
      ...
      <div class="navbar-collapse navbar-custom-collapse collapse" id="navbar-collapse">
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a href="extend.php" class="nav-link">
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              ...
              <p class="text-lead text-white">Please sign-in to your account and start the adventure!</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container mt--8 pb-5">
      <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0">
            <div class="card-body px-lg-5 py-lg-5">
              <div class="text-center text-muted mb-4">
                ...
                <span class="mb-0 text-muted">Please fill in your credentials to login.</span>
              </div>
          ...
          <div class="row mt-3">
            <div class="col-6">
              <a href="javascript:;" class="text-light"><small>Forgot password?</small></a> <!-- Under development -->
            </div>
  ...
  <?php
    ...
    if (isset($_POST["login"]))
    {
      ...
      if (AuthGuard::Login($username, $password))
      {
